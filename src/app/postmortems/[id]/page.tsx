  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <div className="text-xs text-[var(--muted)]">{pm.created_at}</div>
      </header>

      <section className="panel space-y-3 p-4 text-sm">
        <div>
          <h2 className="font-semibold">Summary</h2>
          <p className="text-[var(--muted)]">{pm.summary}</p>
        </div>
        <div>
          <h2 className="font-semibold">Root cause</h2>
          <p className="text-[var(--muted)]">{pm.root_cause}</p>
        </div>
        <div>
          <h2 className="font-semibold">Impact</h2>
          <p className="text-[var(--muted)]">{pm.impact}</p>
        </div>
        <div>
          <h2 className="font-semibold">Resolution</h2>
          <p className="text-[var(--muted)]">{pm.resolution}</p>
        </div>
        <div>
